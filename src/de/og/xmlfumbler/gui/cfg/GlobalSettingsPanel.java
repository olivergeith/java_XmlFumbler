...
import de.og.xmlfumbler.cfg.SettingsPersistor;
import de.og.xmlfumbler.gui.iconstore.IconStore;
import de.og.xmlfumbler.gui.widgets.RomPresetsComboBox;
import de.og.xmlfumbler.main.XmlFumblerMain;
...
public class GlobalSettingsPanel extends SettingsPanel {
	...
	private JPanel createOnStartSettings() {
		...
		final JPanel hide = new HidePanel("What to do on startup of " + XmlFumblerMain.APP_NAME, builder.getPanel());
		return hide;
	}
	...
	public void setSettings(final GlobalSettings settings) {
		if (settings != null) {
			XmlFumblerMain.globalSettings = settings;
	...
	public GlobalSettings getSettings() {
		XmlFumblerMain.globalSettings.setRomPreset((RomPreset) romPresetCombo.getSelectedItem());
		XmlFumblerMain.globalSettings.setShowAdvancedButton(cboxShowAdvancedButton.isSelected());
		XmlFumblerMain.globalSettings.setAlwaysWriteOverview(cboxAlwaysWriteOverviews.isSelected());
		return XmlFumblerMain.globalSettings;
	}
