package de.og.xmlfumbler.gui.widgets.overview;
...
public class OverviewCreator {
	...
	public static BufferedImage createOverviewImage(final List<ImageIcon> iconMap, final String name) {
		if (iconMap != null && iconMap.size() > 0) {
			...
			g2d.drawString("Created with ''The Battery Icon Creator'' V" + XmlFumblerMain.VERSION_NR + " by OlliG", 2, 32);
			g2d.drawString(XmlFumblerMain.HOMEPAGE_URL, 2, h - offsetUnten + 20);
			g2d.setColor(Color.white);
